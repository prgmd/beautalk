...
export const useChatStore = defineStore('chat', () => {
  ...
  function toggleLike(productId) {
    if (likedIds.value.has(productId)) {
      likedIds.value.delete(productId)
    } else {
      likedIds.value.add(productId)
    }
    localStorage.setItem('bt_liked', JSON.stringify([...likedIds.value]))
  }
  ...
  return {
    messages, isLoading, likedIds, recommendedProducts,
