...
| **NF1303** | 데이터 확보 | ✅ | 올리브영 제품 **156종** 크롤링 + AI 요약 + 정제, **`loaddata` 가능한 fixture**(`products_seed.json`, `board_seed.json`) |
...
- 올리브영 제품 **156종**(스킨케어·클렌징·선케어·메이크업) 크롤링, 리뷰를 AI로 요약, 중복·가격·URL 정제.
